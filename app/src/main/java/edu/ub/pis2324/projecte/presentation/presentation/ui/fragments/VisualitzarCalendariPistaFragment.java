...
import edu.ub.pis2324.projecte.databinding.FragmentVisualitzarCalendariPistaBinding;

public class VisualitzarCalendariPistaFragment extends Fragment {
    private FragmentVisualitzarCalendariPistaBinding binding;
    private NavController navController;
    private String esport;


    public static VisualitzarCalendariPistaFragment newInstance() {
        return new VisualitzarCalendariPistaFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        binding = FragmentVisualitzarCalendariPistaBinding.inflate(getLayoutInflater());
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.txtCalendariPistes.setText("Selecciona el dia de la pista de " + esport);
    ...
    private void setupCalendar() {
        ...
        calendarView.setOnDateChangeListener((view,year,month,dayOfMonth) -> {
            ...
            navController.navigate(R.id.action_CalendariPista_to_VisualizarHorasPista,bundle);
        });
    }
}